...
(function() {
  ...
  module.exports = function(options) {
    ...
    return ironsModel = function(req, res, next) {
      var checkPassword, fetchSession, fetchUser, fetchUserByEmail, getSession, getUser, model, newUser, register, sessionAttach, setPassword, _ref;
      ...
      req.irons = {
        ...
        newUser: newUser = function(email, done) {
          var id;
          id = model.id();
        ...
        register: register = function(email, password, done) {
          return newUser(email, function(err, id) {
            if (err) {
              return done(err);
            }
            return fetchUser(id, function(err, user) {
              if (err) {
                return done(err);
              }
